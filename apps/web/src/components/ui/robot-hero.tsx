// Adapted from the marketplace drop-in for this Vite app:
// - "use client" removed (no RSC here)
// - NodeJS.Timeout -> ReturnType<typeof setTimeout> (browser typings)
// - RobotPrototype/ResponsiveGroup exported so the landing can compose the
//   robot without the marketplace navbar. Everything else is verbatim.
